function que4_APC(a, b, str, N1, N2, var1, var2, y_dash, y_sol, alpha)
    n1 = length(N1);
    n2 = length(N2);
    ...
    for i = 1:n1
        ...
        En(i) = Adams_PC(a, b, var2, N1(i), alpha, y_dash, y_sol, disp, str);
        E2n(i) = Adams_PC(a, b, var2, N2(i), alpha, y_dash, y_sol, 0, str);
    end
    orders = zeros(1,n2);
    for i = 1:n2
